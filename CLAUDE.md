...
Inkiva is a WYSIWYG markdown editor built on Electron + Vue 3. It supports CommonMark, GitHub Flavored Markdown, math (KaTeX), Mermaid diagrams, PlantUML, and multiple editing modes (focus, typewriter, source-code).

- **Version**: see `package.json`
- **License**: MIT
- **Repository**: https://github.com/Bulls1986/Inkiva
...
<repo-root>/
  package.json              Workspace orchestrator — every CI-facing script
                            ...
                            inkiva ...`. CI invocations are unchanged.
  ...
  packages/
    desktop/                The Electron app (name: "inkiva").
    ...
    muya/                   TypeScript rewrite of muya
                            ...
                            https://github.com/inkiva/muya). Built on
      ...
      e2e/                  muya-e2e — Playwright suite. CI runs Chromium
                            ...
                            specs.
    website/                inkiva-website (Vite + React 18). Standalone
...
desktop-specific script to `packages/desktop` via `pnpm --filter inkiva`,
...
pnpm --filter inkiva-website dev      # Vite dev server
pnpm --filter inkiva-website build    # static build → packages/website/build/
```
...
Muya  (packages/muyajs/)            ← workspace package @marktext/muyajs
  ...
  └── packages/muya/ (@muyajs/core, the TS rewrite from
      https://github.com/inkiva/muya) has landed and is now the engine
