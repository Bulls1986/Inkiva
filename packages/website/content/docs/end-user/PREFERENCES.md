...
| titleBarStyle          | String  | `custom`      | The title bar style on Windows: `custom` or `native`.                                                                       |
...
| startUpAction          | String  | `restoreAll`  | The action when Inkiva launches. Optional values: `folder`, `openLastFolder`, `blank`, `restoreAll`.                     |
| defaultDirectoryToOpen | String  | `""`          | The path that should be opened when `startUpAction=folder`.                                                                |
| language               | String  | `en`          | The display language Inkiva uses.                                                                                        |
...
| lineHeight                         | Number  | `1.7`              | Line height. Range `1.2`–`2.0`.                                                                                                                                                      |
...
| Key              | Type   | Default | Description                                                          |
| ---------------- | ------ | ------- | -------------------------------------------------------------------- |
| lastOpenedFolder | String | `""`    | The last folder opened in Inkiva (used for session restore).       |
