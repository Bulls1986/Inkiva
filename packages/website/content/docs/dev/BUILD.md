...
The easiest way to build Inkiva on Linux is from inside a container.
Here are the steps for doing so:
```sh
# cd to inkiva repository
...
1. Go to `inkiva` folder
2. Install dependencies: `pnpm install`
3. Build Inkiva binaries and packages: `pnpm run build`
4. Inkiva binary is located under `dist` folder (electron-builder output)
...
| Script  | Description                                      |
| ------- | ------------------------------------------------ |
| `build` | Build Inkiva binaries and packages for your OS |
| `dev`   | Build and run Inkiva in developer mode         |
